...
path_dist_maps <- "../mapping/results/version1.1/"
path_forest <- "../mapping/results/version1.0/"
...
for (i in 1:length(countries)) {
  ...
  write_csv(forest, paste0("data/disturbances/aggregated_to_grid/forests_aggregated_to_grid_", cntr, ".csv"))
